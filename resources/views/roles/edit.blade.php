        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start">
                    <i class="bi bi-shield-check me-2"></i>Edit Peranan: <strong>{{ $role->name }}</strong>
                </div>
                <div class="float-end">
            ...
            <div class="card-body">
                <form action="{{ route('roles.update', $role->id) }}" method="post">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $role->name) }}" placeholder="Contoh: Admin, Editor, ...">
                            @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            ...
                            @php
                                ...
                                foreach ($permissions as $perm) {
                                    ...
                                    foreach ($knownActions as $act) {
                                        if (str_starts_with($name, $act . '-')) {
                                            $action = $act;
                                            $module = substr($name, strlen($act) + 1);
                                            break;
                                        }
                                    }
                                ...
                                $selectedPermIds = old('permissions', $rolePermissions);
                            @endphp
                                                ...
                                                <div class="col-md-3 col-lg-2">
                                                    <div class="form-check permission-check-{{ $module }}">
                                                        <input class="form-check-input module-{{ $module }}-check" type="checkbox"
                                                               ...
                                                               id="perm_{{ $perm->id }}"
                                                               {{ in_array($perm->id, $selectedPermIds) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-9 offset-md-3">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-save"></i> Kemaskini Peranan
                            </button>
                        </div>
                    </div>
