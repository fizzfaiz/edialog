...
<script>
    ...
    function renumberAttendanceRows(){document.querySelectorAll('#attendancesBody tr').forEach((r,i)=>{r.querySelector('.att-bil-input').value=i+1;r.querySelector('input[name*="[nama]"]').name=`attendances[${i}][nama]`;r.querySelector('input[name*="[jawatan]"]').name=`attendances[${i}][jawatan]`});attRowIndex=document.querySelectorAll('#attendancesBody tr').length}
